...
#define CLANG_DEFAULT_LINKER "ld.lld"

/* Default C/ObjC standard to use. */
#define CLANG_DEFAULT_STD_C LangStandard::lang_c17
...
#define CLANG_DEFAULT_OBJCOPY "llvm-objcopy"
...
#define CLANG_RESOURCE_DIR "/usr/lib/clang/8.0.1"
...
#define BACKEND_PACKAGE_STRING "LLVM 8.0.1libcxx"
